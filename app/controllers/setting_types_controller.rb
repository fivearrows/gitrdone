  ...
  def create
    ...
    respond_to do |format|
      if @setting_type.save
        format.html { redirect_to(@setting_type, :notice => 'SettingType was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @setting_type.update_attributes(params[:setting_type])
        format.html { redirect_to(@setting_type, :notice => 'SettingType was successfully updated.') }
        format.xml  { head :ok }
      else
